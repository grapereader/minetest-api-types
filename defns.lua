...
---@field schematic string | { size: Vec, data: MapNode[], yslice_prob: { ypos: integer, prob: integer }[] }
...
---@field allow_put fun(pos: Vec, listname: string, index: integer, stack: ItemStack, player: PlayerObjectRef): integer
---@field allow_take fun(pos: Vec, listname: string, index: integer, stack: ItemStack, player: PlayerObjectRef): integer
---@field on_move fun(pos: Vec, from_list: any, from_index: integer, to_list: any, to_index: integer, count: integer, player: PlayerObjectRef): nil
---@field on_put fun(pos: Vec, listname: string, index: integer, stack: ItemStack, player: PlayerObjectRef): nil
---@field on_take fun(pos: Vec, listname: string, index: integer, stack: ItemStack, player: PlayerObjectRef): nil
...
---@param cb fun(pos: Vec, newnode: any, placer: AnyObjectRef|nil, oldnode: any, itemstack: ItemStack, pointed_thing: PointedThing): nil
function minetest.register_on_placenode(cb) end
---@param cb fun(pos: Vec, oldnode: any, digger: AnyObjectRef|nil): nil
function minetest.register_on_dignode(cb) end
---@param cb fun(pos: Vec, node: any, puncher: AnyObjectRef|nil): nil
function minetest.register_on_punchnode(cb) end
---@param cb fun(minp: Vec, maxp: Vec, blockseed: any): nil
...
---@param cb fun(player: PlayerObjectRef, hitter: PlayerObjectRef, time_from_last_punch: number, tool_capabilities: ToolCapabilities, dir: Vec, damage: number): nil
...
---@param cb fun(pos: Vec, name: string): nil
...
---@param cb fun(pos_list: Vec[], node_list: any[]): nil
...
---@return table<string, Vec>|Vec[], nil|table<string, integer>
...
---@param pos1 Vec
---@param pos2 Vec
---@param callback? fun(blockpos: Vec, action: any, calls_remaining: integer, param: any)
...
---@param location { type: '"player"', name: string } | { type: '"node"', pos: Vec } | { type: '"detached"', name: string }
...
---@param limit number
---@return { actor: string, pos: Vec, time: number, oldnode: MapNode, newnode: MapNode }
...
---@return ItemStack, Vec | nil position
...
---@param p1 Vec
---@param p2 Vec
---@param probability_list { pos: Vec, prob: integer }[]
---@param filename string
...
---@param time_from_last_punch number
---@return number
function minetest.calculate_knockback(player, hitter, time_from_last_punch) end
---@param pos Vec
